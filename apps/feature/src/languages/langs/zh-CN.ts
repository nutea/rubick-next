  ...
  'zh-CN': {
    feature: {
      ...
      superPanelShortcut: {
        ...
        providerAnthropic: 'Anthropic 兼容 Messages API',
        translateConfigHint:
          '可保存多组接口配置并切换使用；未配置完整时无法开启「自动翻译」。OpenAI 使用 Bearer；Anthropic 使用 x-api-key 与 anthropic-version。',
        profileSelect: '当前配置',
        profileName: '配置名称',
        addProfile: '新增配置',
        deleteProfile: '删除',
        ...
        anthropicUrlPh: '例如 https://api.anthropic.com/v1/messages',
        anthropicApiKey: 'API Key（x-api-key）',
        anthropicApiVersion: 'Anthropic API 版本（anthropic-version）',
