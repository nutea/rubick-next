  ...
  'en-US': {
    feature: {
      ...
      superPanelShortcut: {
        ...
        providerAnthropic: 'Anthropic-compatible Messages API',
        translateConfigHint:
          'You can save multiple endpoint profiles and pick one. Auto-translate stays off until a profile is complete. OpenAI uses Bearer; Anthropic uses x-api-key and anthropic-version.',
        ...
        anthropicUrlPh: 'e.g. https://api.anthropic.com/v1/messages',
        anthropicApiKey: 'API key (x-api-key)',
        anthropicApiVersion: 'Anthropic API version (anthropic-version)',
